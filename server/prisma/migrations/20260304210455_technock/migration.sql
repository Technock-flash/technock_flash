...
-- CreateTable
CREATE TABLE "VendorCategoryPreference" (
    "vendorId" TEXT NOT NULL,
    "categoryId" TEXT NOT NULL,

    CONSTRAINT "VendorCategoryPreference_pkey" PRIMARY KEY ("vendorId","categoryId")
);
...
CREATE TABLE "Product" (
    ...
    "vendorId" TEXT NOT NULL,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "moderationStatus" "ProductModerationStatus" NOT NULL DEFAULT 'APPROVED',
...
-- AddForeignKey
ALTER TABLE "VendorCategoryPreference" ADD CONSTRAINT "VendorCategoryPreference_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "Vendor"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VendorCategoryPreference" ADD CONSTRAINT "VendorCategoryPreference_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;
